...
class controller {
    public function render(array $GET, array $POST) {
        // Need to make a separate register/auth/login page before the user gets to the other results in the db
    ...
    private function validator() {
        // Errors should go in an array: no echo'ing in the controller.
